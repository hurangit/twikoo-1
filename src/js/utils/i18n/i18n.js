...
export default {
  ...
  [S.ACI + '_IMAGE_CDN']: [
    '插入图片所使用的图床，目前支持：HuRan公益图床、qcloud',
    '插入圖片所使用的圖床，目前支持：HuRan公益图床、qcloud',
    '插入圖片所使用的圖床，目前支援：HuRan公益图床、qcloud',
    'The image bed for image uploading. Select from: HuRanimg、qcloud'
  ],
  [S.ACI + '_IMAGE_CDN_TOKEN']: [
    'HuRan 的图床 token',
    'HuRan 的图床 token',
    'HuRan 的图床 token',
    'The image bed token for HuRan.'
  ],
